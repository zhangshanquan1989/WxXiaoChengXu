// miniprogram/pages/driverInfo/driverInfo.js
...
selectResult: function (e) {
    ...
    wx.navigateTo({
      url: '../driverInfoDetails/driverInfoDetails?driverId='+e.detail.item.id,
    })
},
...
getList(){
  _request({
    ...
    this.setData({
      driverList:[...this.data.driverList,...res.data.result.records]
    })
  })
  //关闭下拉刷新的窗口
